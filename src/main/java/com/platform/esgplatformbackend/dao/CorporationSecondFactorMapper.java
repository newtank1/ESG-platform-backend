...
public interface CorporationSecondFactorMapper {
    ...
    @Select("select * from corporation_second_factor where industry=#{industry}")
    ...
    @Select("select * from corporation_second_factor where industry=#{industry} and score_type=#{score_type}")
