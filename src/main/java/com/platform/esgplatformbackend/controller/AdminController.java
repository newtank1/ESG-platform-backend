...
public class AdminController {
    ...
    @PostMapping("/ESG")
    public ResultVO<CorporationESGVo> submitESG(@RequestBody CorporationESGScoreVo vo){
    ...
    public List<CorporationESGScoreVo> getESGHistory(@PathVariable Integer corporation_id){
